...
gui_xm_select_font(char_u *current)
{
	...
	n++;
	XtSetArg(args[n], XmNrightWidget, sub_form);
	n++;
	...
	n = 0;
	XtSetArg(args[n], XmNsubMenuId, data->encoding_pulldown);
	++n;
	XtSetArg(args[n], XmNlabelString, str);
	++n;
	...
	++n;
	XtSetArg(args[n], XmNbottomWidget, size_toggle);
	++n;
	XtSetArg(args[n], XmNbottomOffset, 4);
	++n;
	XtSetArg(args[n], XmNrightAttachment, XmATTACH_WIDGET);
	++n;
	XtSetArg(args[n], XmNrightWidget, separator);
	++n;
	XtSetArg(args[n], XmNrightOffset, 4);
	++n;
	...
	n = 0;
	XtSetArg(args[n], XmNvisibleItemCount, 8);
	++n;
