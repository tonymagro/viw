...
# ifdef FEAT_MOUSE_DEC
				if (key_name[0] == (int)KS_DEC_MOUSE) {
					...
					*/
					...
					switch (Pe) {
					case  0:
						return -1; /* position request while unavailable */
			    ...
			    the status of all buttons */
					...
					case  7:
						...
						break;
					case  8:
						return -1; /* fourth button down */
					case  9:
						return -1; /* fourth button up */
					case 10:
						return -1; /* mouse outside of filter rectangle */
					default:
